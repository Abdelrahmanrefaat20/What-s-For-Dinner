...
var mealReviews = document.getElementById("mealReviews");
var mealPrepTime = document.getElementById("mealPrepTime");
var mealCookTime = document.getElementById("mealCookTime");
var mealServings = document.getElementById("mealServings");
var mealName = document.getElementById("mealName");
var mealDescription = document.getElementById("mealDescription");
var mealDifficulty = document.getElementById("mealDifficulty");
...
var mealCalories = document.getElementById("mealCalories");
var mealProtein = document.getElementById("mealProtein");
var mealCarbs = document.getElementById("mealCarbs");
var mealFat = document.getElementById("mealFat");
var mealFiber = document.getElementById("mealFiber");
var mealSodium = document.getElementById("mealSodium");
...
var data = [
  ...
  },
  {
    ...
    warningText: "This recipe takes more than 90 minutes.",
  ...
  },
  {
    ...
    cookTime: "60 min",
    totalTime: 75,
    warningTitle: "Patience Required",
    warningText: "Caramelizing the onions takes about 40 minutes.",
    servings: "4 people",
    difficulty: "Intermediate",
    category: "Mediterranean",
    ratingsAverage: 4.7,
  ...
  },
  {
    ...
    prepTime: "15 min",
    cookTime: "240 min",
    warningTitle: "Long Cooking Time",
    warningText: "This recipe needs about 4 hours of cooking.",
    totalTime: 255,
    servings: "4 people",
    difficulty: "Easy",
    category: "American",
...
function displayMeal(meal) {
  mealImage.src = meal.imgCover;
  mealRating.innerHTML = meal.ratingsAverage;
  mealReviews.innerHTML = `(${meal.ratingsQuantity} reviews)`;
  mealPrepTime.innerHTML = meal.prepTime;
  mealCookTime.innerHTML = meal.cookTime;
  mealServings.innerHTML = meal.servings;
  mealCalories.innerHTML = meal.nutrition.calories;
  mealProtein.innerHTML = meal.nutrition.protein;
  mealCarbs.innerHTML = meal.nutrition.carbs;
  mealFat.innerHTML = meal.nutrition.fat;
  mealFiber.innerHTML = meal.nutrition.fiber;
  mealSodium.innerHTML = meal.nutrition.sodium;
  mealDifficulty.innerHTML = meal.difficulty;
  mealCategory.innerHTML = meal.category;
  mealDescription.innerHTML = meal.description;
...
var box = "";
  for (let i = 0; i < meal.instructions.length; i++) {
   box += `
            <div class="d-flex gap-3 align-items-center my-3">
                <div class="box-profile py-2 px-3 rounded-4 text-white">
                    ${i + 1}
                </div>
 ...
 var box = "";
  for (let i = 0; i < meal.tips.length; i++) {
   box+= `
            <div class="col-12">
                <div class="tip-card d-flex align-items-center rounded-4 p-3">
                    <div class="tip-icon rounded-circle d-flex justify-content-center align-items-center">
                        <i class="fa-solid fa-circle-check fa-lg" style="color:#f59e0b;"></i>
                    </div>
  ...
  if (meal.warningTitle && meal.warningText) {
    warningBox.style.display = "block";
    warningTitle.innerHTML = meal.warningTitle;
    warningText.innerHTML = meal.warningText;
  } else {
